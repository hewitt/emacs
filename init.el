...
(custom-set-variables
 ...
 '(package-selected-packages
   '(chocolate-theme company-posframe dracula-theme org-superstar mu4e-conversation all-the-icons which-key helm-projectile projectile treemacs helm-posframe dashboard doom-themes use-package))
 '(tool-bar-mode nil))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Iosevka Term SS05" :foundry "CYEL" :slant normal :weight normal :height 150 :width normal)))))
